...
namespace av {
	...
	std::optional<GraphicsDevice::QueueFamilyIndices> GraphicsDevice::QueueFamilyIndices::get_queue_family_indices(
	...
	bool GraphicsDevice::physical_device_is_compatible(
		vk::raii::PhysicalDevice const &physical_device,
		vk::raii::SurfaceKHR const &surface
	) {
		{
...
//					std::bind(std::equal_to<std::string>(), device_extension, std::placeholders::_1));
	...
	vk::raii::PhysicalDevice GraphicsDevice::choose_physical_device(
		vk::raii::Instance const &instance,
		vk::raii::SurfaceKHR const &surface
	) {
	...
	vk::raii::Device GraphicsDevice::create_device(
		vk::raii::PhysicalDevice const &physical_device,
		GraphicsDevice::QueueFamilyIndices const &queue_family_indices
	) {
	...
	vk::raii::CommandPool GraphicsDevice::create_graphics_command_pool(
