...
av::GraphicsState::GraphicsState(
	vk::raii::SurfaceKHR const &surface,
	GraphicsDevice const &gpu,
	std::tuple<size_t, size_t> const &framebuffer_size
)
	: vertex_shader_module{create_shader_module(av::constants::VERTEX_SHADER_FILE_NAME, gpu)}
	, fragment_shader_module{create_shader_module(av::constants::FRAGMENT_SHADER_FILE_NAME, gpu)}
...
void av::GraphicsState::recreate(
	vk::raii::SurfaceKHR const &surface,
	GraphicsDevice const &gpu,
	std::tuple<size_t, size_t> const &framebuffer_size
) {
	...
	new(&_surface_info) SurfaceInfo{surface, gpu, framebuffer_size};
...
vk::raii::ShaderModule av::GraphicsState::create_shader_module(
...
vk::raii::PipelineLayout av::GraphicsState::create_pipeline_layout(GraphicsDevice const &gpu) {
...
vk::raii::SwapchainKHR av::GraphicsState::create_swapchain(
	vk::raii::SurfaceKHR const &surface,
	GraphicsDevice const &gpu,
...
vk::raii::RenderPass av::GraphicsState::create_render_pass(
	GraphicsDevice const &gpu,
	SurfaceInfo const &surface_info
) {
...
vk::raii::Pipeline av::GraphicsState::create_pipeline(
	GraphicsDevice const &gpu,
