...
vk::SurfaceFormatKHR av::SurfaceInfo::choose_surface_format(
	vk::raii::SurfaceKHR const &surface,
	GraphicsDevice const &gpu
) {
...
vk::PresentModeKHR av::SurfaceInfo::choose_present_mode(
	vk::raii::SurfaceKHR const &surface,
	GraphicsDevice const &gpu
) {
...
vk::Extent2D av::SurfaceInfo::get_extent(
